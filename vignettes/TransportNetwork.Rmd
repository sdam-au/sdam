...
```{r, tnet1, echo=TRUE, eval=TRUE, out.width="70%", fig.align="center", fig.cap="Roman Empire with provinces in year 120AD"}
...
<div class="row">
<div class="col-md-6">
```{r, echo=TRUE, eval=TRUE, fig.align="center", fig.cap="Senatorial and Imperial provinces with roads and shipping routes"}
# Roman Empire transport system with provinces
plot.map(type="si", roads=TRUE, shipr=TRUE)
```
</div>
<div class="col-md-6">
```{r, echo=TRUE, eval=TRUE, fig.align="center", fig.cap="Senatorial and Imperial provinces with roads, shipping routes, and settlements"}
# Roman Empire transport system with provinces

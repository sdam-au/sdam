...
<p class="output">
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[2]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[3]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[4]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[5]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[6]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[7]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[12]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[13]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[15]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[16]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[17]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[18]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[19]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[22]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[24])[[1]])
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[26]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[27]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(edhs$Ach$nomen, 50)[38]))
```
</p>
`r emo::ji("smile")`
...
<p class="output">
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 5)[1]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 4)[1]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 3)[1]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 2)[1]))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 1)))
```
</p>
...
<p class="output">
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 3)[1], level=2))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 2)[1], level=2))
```
<br>
```{r, echo=FALSE, eval=TRUE}
knitr::asis_output(cln(utils::tail(Aeg, 1), level=2))
```
</p> -->
